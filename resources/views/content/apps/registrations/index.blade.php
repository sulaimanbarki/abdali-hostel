        ...
        <tbody>
          ...
          <tr>
            ...
            <td> 
                ...
                <a href="{{ route('registrations.show', $registration->id) }}" class="btn btn-warning btn-sm"><i data-feather="eye" class="font-medium-3"></i></a>
                <a href="{{ route('registrations.edit', $registration->id) }}" class="btn btn-primary btn-sm"><i data-feather="edit-2" class="font-medium-3"></i></a>
                {!! Form::open(['method' => 'DELETE','route' => ['registrations.destroy', $registration->id],'style'=>'display:inline']) !!}
