        ...
        <div class="card-body">
            ...
            <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="client_company_name" placeholder="Client Company Name" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="end_date" placeholder="Project End Date" required>
                </div>
                ...
                <div id="app">
                    <div class="form-group">
                        ...
                        {{ BsForm::image('icon')->collection('icon')->files() }}
                    </div>
                    <div class="form-group">
                        <label for="Logo">Project Attachment </label>
                        {{ BsForm::media('project')->unlimited()->collection('project')->files() }}
                    </div>
                </div>
                <div class="form-group">
