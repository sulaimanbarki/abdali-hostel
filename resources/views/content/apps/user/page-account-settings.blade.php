        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
              ...
              <form method="post" action="{{url('admin/update-setting')}}">
                @csrf
                <!-- header media -->
                <div class="media">
                  <a href="javascript:void(0);" class="mr-25">
                    <div class="form-group" id="app">
                      ...
                      {{ BsForm::image('profile')->collection('profile')->files($user->getMediaResource('profile')) }}
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group form-password-toggle input-group-merge">
                        <input type="password" class="form-control" id="account-retype-new-password" name="confirm-password" placeholder="New Password" />
                        <div class="input-group-append">
                  ...
                  <div class="col-12 mt-1">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 col-md-3 text-center mb-1">
                        ...
                        <div class="avatar mb-1">
                          <span class="avatar-content">
                            <img src="{{asset('images/avatars/11-small.png')}}" alt="avatar img" width="40" height="40" />
                          </span>
                        </div>
                      ...
                      <div class="col-6 col-md-3 text-center mb-1">
                        ...
                        <div class="avatar mb-1">
                          <span class="avatar-content">
                            <img src="{{asset('images/avatars/3-small.png')}}" alt="avatar img" width="40" height="40" />
                          </span>
                        </div>
