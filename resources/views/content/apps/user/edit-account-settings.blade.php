        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <a href="javascript:void(0);" class="mr-25">
                  <img src="{{asset('images/portrait/small/avatar-s-11.jpg')}}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                            </a>
                        ...
                        <!-- form -->
                        <form action="{{ route('update-settings', Auth::User()->id) }}" class="mt-2" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
