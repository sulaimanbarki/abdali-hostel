...
<x-inner-page-header page='development-expenditures' slug='development-expenditures' />
    ...
    <div class="custom-container">
        ...
        <div class="table-responsive">
            <table class="table text-center pricing-table">
                <thead>
                    <tr>
                        <th width="6%" rowspan="2" class="bg">
                            <h3>S.No</h3>
                        </th>
                        <th width="17%" rowspan="2" class="bg">
                            <h3>District</h3>
                        </th>
                        <th colspan="3" class="bg">
                            <h3>Types of Roads</h3>
                        </th>
                        <th width="10%" rowspan="2" class="bg">
                            <h3>Total</h3>
                        </th>
                    </tr>
                    <tr>
                        <th width="20%" class="bg-1">
                            <h3>Major Roads</h3>
                        </th>
                        <th width="18%" class="bg-1">
                            <h3>Link Roads</h3>
                        </th>
                        <th width="29%" class="bg-1">
                            <h3>Fair Weather Roads</h3>
                        </th>
                    </tr>
